...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\David\\Documents\\GitHub\\OpenBrains\\Square_game2_new\\task\\SquareDot2_lastrun.py',
...
circle_falling = visual.Polygon(
    win=win, name='circle_falling',
    edges=30, size=(0.15, 0.25),
    ori=0, pos=[0,0],
    lineWidth=1, lineColor=[0,0,0], lineColorSpace='rgb',
    fillColor=[0,0,0], fillColorSpace='rgb',
