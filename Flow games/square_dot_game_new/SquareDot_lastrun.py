...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\David\\Documents\\GitHub\\OpenBrains\\Square_game_new\\task\\SquareDot_lastrun.py',
...
for thisRepeat in repeat:
    ...
    while continueRoutine:
        ...
        if text_repeat.status == STARTED:  # only update if drawing
            text_repeat.setText('¿Quieres continuar?\n\n        SÍ: pulsa "S"\n\n        NO: pulsa "N"', log=False)
