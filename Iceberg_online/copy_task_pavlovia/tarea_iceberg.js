...
function Ronda1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ronda2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instrumentalRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instrumentalComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ronda3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function lyricsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of lyricsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ronda4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function multitaskingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of multitaskingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
