...
def carregar_epochs_des_de_carpeta(folder_path, fs=200, pre_trigger_sec=3, export_epochs=True):
    """
    ...
    eeg_signal = np.array(eeg_signal, dtype=np.float32)  # Tipus de dada explícit
