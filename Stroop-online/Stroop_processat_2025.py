...
for file in files:
    ...
    df = df_all[['texto', 'farber', 'farbeg', 'farbeb', 'respuesta.rt', 'respuesta_rect.rt', 'respuesta_mix.rt', 'participant']] 
    #
    ...
    df1 = df[['texto', 'farber', 'farbeg', 'farbeb', 'rt', 'participant']]
    #
    ...
    df1['perfil_color'] = 'negro' 
    df1['color'] = df1['perfil_color'].astype(str) + df1['farber'].astype(str) + df1['farbeg'].astype(str) + df1['farbeb'].astype(str)
    df1['color'] = df1['color'].replace(['negronannannan','negro1.00.1-1.0', 'negro0.004-1.00.004', 'negro-1.0-1.01.0', 'negro-1.00.04-1.0'], ['negro', 'naranja', 'lila', 'azul', 'verde'])
    #
