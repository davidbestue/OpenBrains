...
function color_negroRoutineBegin() {
  ...
  for (const thisComponent of color_negroComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function color_rectanguloRoutineBegin() {
  ...
  for (const thisComponent of color_rectanguloComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function color_variadoRoutineBegin() {
  ...
  for (const thisComponent of color_variadoComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
...
function graciasRoutineBegin() {
  ...
  for (const thisComponent of graciasComponents)
    if ('status' in thisComponent)
      thisComponent.status = PsychoJS.Status.NOT_STARTED;
