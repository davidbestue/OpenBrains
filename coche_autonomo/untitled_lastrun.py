...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\david\\OneDrive\\Documentos\\imagenes_coche\\untitled_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        hm_final = sum(hm)/hm_max * 100
        cp_final = sum(cp) / cp_max * 100
        ai_final = sum(ai) /ai_max * 100
        pa_final = sum(pa) /pa_max * 100
        vr_final = sum(vr) / vr_max * 100
    ...
    # keep track of which components have finished
    resultsComponents = [text, text_2, text_3, text_4, text_5]
