...
function Ronda_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function musicRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of musicComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_wordsRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_wordsComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_videoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_videoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ronda_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function control2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of control2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_words2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_words2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_video2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_video2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ronda_3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda_3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function control3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of control3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_words3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_words3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_video3RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_video3Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ronda_4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ronda_4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function control4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of control4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_words4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_words4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_video4RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_video4Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
